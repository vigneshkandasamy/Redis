...
module.exports = function(app) {
  ...
  app.post("/api/auth/delete", [jwtAuth.verifyToken], productServices.delete);
    ...
    // add user product
    app.post("/api/auth/userproduct", [jwtAuth.verifyToken], productServices.assign);

    // add user product
    app.get("/api/auth/getuserproducts", [jwtAuth.verifyToken], productServices.getUserProducts);
